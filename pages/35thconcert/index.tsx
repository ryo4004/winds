...
const Concert = () => {
  // 終演表示の設定
  const END_DATETIME = DateTime.fromISO('2022-10-09T16:00:00.000')
  const show = DateTime.now() > END_DATETIME
      ...
      <div className={classNames(styles.home, filter ? styles.dark : styles.light)}>
        ...
        <section className={styles.about}>
          ...
          <div className={styles.text}>
            <p>
              ザ・ウィンド・アンサンブルでは2022年10月9日(日)に長岡リリックホールにて第35回定期演奏会を予定しています。
            </p>
            <p>
        ...
        <section className={styles.program}>
          ...
          <div className={styles.contents}>
            <div>
              <span className={styles.title}>サンダーバード</span>
              <wbr />
              <span className={styles.composer}>B.グレイ/P.スパーク</span>
            </div>
            <div>
              <span className={styles.title}>海の歌</span>
              <wbr />
              <span className={styles.composer}>R.ミッチェル</span>
            </div>
            <div>
              <span className={styles.title}>「千と千尋の神隠し」ハイライト</span>
              <wbr />
              <span className={styles.composer}>久石譲/遠藤幸夫</span>
            </div>
            <div>
              <span className={styles.title}>祝典のための音楽</span>
              <wbr />
              <span className={styles.composer}>P.スパーク</span>
            </div>
            <div>
              <span className={styles.title}>吹奏楽のための「エール・マーチ」</span>
              <wbr />
              <span className={styles.composer}>宮下秀樹</span>
            </div>
            <div>
              <span className={styles.title}>ローマの噴水</span>
              <wbr />
              <span className={styles.composer}>O.レスピーギ/河本隆吉</span>
            </div>
          </div>
        </section>
        ...
        <section className={styles.poster}>
          ...
          <div className={styles.contents}>
            <figure>
              <img src="35thconcert/poster.jpg" />
            </figure>
            <a href="35thconcert/poster.jpg" target="_blank" rel="noreferrer" download>
              ダウンロード
            </a>
          </div>
        </section>
