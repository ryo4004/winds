  ...
  return (
    <div className={styles.concert}>
      <div className={styles.header}>
        <header>
          <a href="https://winds-n.com">
            <svg
              ...
              className={styles['svg-logo-30thconcert']}
            >
              <defs>
                <linearGradient id="gradient" gradientUnits="userSpaceOnUse" gradientTransform="rotate(45)">
                  <stop offset="0%" stopColor="#612200" stopOpacity="1" />
                  <stop offset="13.33%" stopColor="#b97b18" stopOpacity="1" />
                  <stop offset="28.48%" stopColor="#e6b433" stopOpacity="1" />
                  <stop offset="40.61%" stopColor="#eee25e" stopOpacity="1" />
                  <stop offset="54.55%" stopColor="#fff" stopOpacity="1" />
                  <stop offset="66.06%" stopColor="#fff" stopOpacity="1" />
                  <stop offset="75.15%" stopColor="#eee25e" stopOpacity="1" />
                  <stop offset="84.85%" stopColor="#dea62c" stopOpacity="1" />
                  <stop offset="100%" stopColor="#924300" stopOpacity="1" />
                </linearGradient>
              </defs>
              <path
                d="M154.833,7.192c-1.066,1.923-1.604,3.794-1.96,5.031l-0.254,0.85c-1.737,5.345-6.915,4.384-7.135,4.34l-0.04,0.206
        c0.056,0.012,5.58,1.043,7.374-4.482l0.257-0.855c0.354-1.229,0.888-3.086,1.941-4.988c1.348-2.43,4.787-4.421,7.835-4.531
        l-0.008-0.209C159.73,2.666,156.213,4.705,154.833,7.192z"
              />
              <path
                d="M201.78,18.465c-6.977-3.297-11.192,1.847-11.235,1.898l0.164,0.133c0.041-0.052,4.158-5.065,10.981-1.842
        ...
        c-1.64-3.021-0.649-5.631-0.649-5.631l0,0C141.98,15.567,143.967,12.398,147.732,12.989z"
              />
              <path
                d="M184.678,23.7l-0.318-0.002l-6.222-12.241h-0.042l-2.625,10.105c-0.168,0.641-0.032,1.351,1.708,1.361l-0.107,0.42
        ...
        l-0.108,0.42c-1.742-0.011-2.245,0.695-2.41,1.336L184.678,23.7z"
              />
              <path
                d="M188.907,18.965l0.487,0.002c0.125,2.062,1.127,3.928,3.38,3.942c1.72,0.011,3.288-1.53,3.248-3.259
        ...
        c-2.208-0.015-3.318-1.638-3.949-0.025l-0.466-0.002L188.907,18.965z"
              />
              <path
                d="M198.688,23.477l0.11-0.42c1.549,0.01,2.052-0.695,2.219-1.338l2.884-11.099c0.166-0.642,0.032-1.351-1.518-1.361
        ...
        c1.699,0.011,3.318-0.001,5.174-2.801l0.593,0.004l-1.925,3.729L198.688,23.477z"
              />
              <path
                d="M228.265,21.889c-0.169,0.641-0.031,1.351,1.517,1.359l-0.108,0.421l-5.905-0.037l0.109-0.419
        ...
        c-1.551-0.01-2.053,0.696-2.22,1.337L228.265,21.889z"
              />
              <path
                d="M236.322,16.491l1.063,0.007c1.996,0.012,4.396,0.514,3.714,3.145c-0.673,2.586-2.485,3.262-4.694,3.248
        ...
        c1.412,0.297,2.196,1.209,1.76,2.891c-0.464,1.791-1.966,2.734-4.11,2.72L236.554,15.606z"
              />
              <path
                d="M244.006,23.758l0.11-0.42c1.55,0.01,2.052-0.695,2.221-1.337l2.883-11.1c0.165-0.642,0.031-1.351-1.518-1.361
        l0.107-0.419l5.903,0.036l-0.11,0.42c-1.548-0.009-2.052,0.696-2.218,1.337l-2.884,11.1c-0.16,0.619,0.582,0.867,1.899,0.876
        c2.698,0.017,4.563,0.116,6.52-2.905l0.531,0.004l-2.02,3.84L244.006,23.758z"
              />
              <path
                d="M256.747,23.836l0.11-0.42c1.549,0.01,2.051-0.695,2.218-1.337l2.885-11.099c0.166-0.642,0.032-1.351-1.518-1.36
        ...
        c1.697,0.01,3.316-0.002,5.171-2.803l0.596,0.003l-1.927,3.731L256.747,23.836z"
              />
              <path
                d="M111.414,5.652c-1.198-0.858-3.864-1.262-3.864-1.262c-8.43-1.487-12.164,6.136-12.164,6.136s-4.248,7.353-9.312,10.826
        ...
        C79.98,4.982,80.533,4.852,80.859,4.912z"
              />
              <path
                d="M98.936,21.491c-0.166,0.641-0.031,1.35,1.73,1.361l-0.107,0.42l-6.33-0.039l0.109-0.42
        c1.764,0.011,2.266-0.694,2.432-1.336l2.885-11.1c0.167-0.642,0.032-1.351-1.731-1.362l0.11-0.42l6.329,0.039l-0.109,0.42
        c-1.763-0.011-2.266,0.695-2.433,1.335L98.936,21.491z"
              />
              <path
                d="M112.816,23.659l-0.318-0.003l-6.219-12.241h-0.044l-2.623,10.104c-0.168,0.642-0.033,1.351,1.709,1.361l-0.11,0.421
        ...
        c-1.743-0.01-2.245,0.695-2.412,1.337L112.816,23.659z"
              />
              <path
                d="M121.97,10.693c0.277-1.061,0.486-1.126,1.503-1.12c3.93,0.024,6.068,2.274,4.942,6.607
        ...
        c1.551,0.01,1.685,0.72,1.518,1.361l-2.882,11.099c-0.167,0.642-0.67,1.347-2.22,1.338l-0.11,0.42L120.288,23.394z"
              />
              <path
                d="M42.757,15.263l1.282-4.93c0.166-0.642,0.03-1.351-1.519-1.361l0.108-0.42l5.904,0.037L48.424,9.01
        ...
        l5.902,0.036l-0.109,0.42c-1.549-0.01-2.053,0.695-2.217,1.337l-1.282,4.931L42.757,15.263z"
              />
              <path
                d="M45.238,23.229l0.11-0.42c1.551,0.01,2.052-0.695,2.218-1.336l2.885-11.101c0.167-0.64,0.032-1.351-1.518-1.361
        ...
        c1.698,0.01,3.318-0.002,5.172-2.804l0.595,0.005l-1.926,3.73L45.238,23.229z"
              />
              <path
                d="M27.634,11.678c-2.145,5.648-2.847,11.318-9.706,13.766c0,0-0.23,0.104-1.092,0.348c-0.445,0.121-0.935,0.14-0.935,0.14
        ...
        C34.906,6.24,29.778,6.03,27.634,11.678z"
              />
              <path
                d="M29.373,1.568c-3.031-0.309-5.406,0.252-7.237,1.167c-1.408-1.077-3.151-1.86-5.168-2.275
        ...
        c1.621-1.479,3.72-2.464,4.932-2.955C24.583,5.369,25.542,7.353,25.799,9.641z"
              />
            </svg>
          </a>
        </header>
