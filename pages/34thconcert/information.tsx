  ...
  return (
    <Layout
      ...
      pathList={[
        ...
        { path: '/34thconcert/information', label: 'お知らせ' },
      ]}
    >
      <Block
        title="新型コロナウイルス感染症対策について"
        subTitle="Countermeasures for infectious diseases"
        update="2021/9/26 21:00"
      >
        <Text>
          <div className={styles.information}>
            <p>ザ・ウィンド・アンサンブルでは2021年10月10日(日)に第34回定期演奏会を開催いたします。</p>
            <p>
            ...
            <ul>
              ...
              <li>座席については、グループ・個人ごとに1席空けて着席ください。</li>
              <li>一度着席した後は席の移動はご遠慮ください。</li>
